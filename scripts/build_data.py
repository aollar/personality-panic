...
def main():
    ...
    buildings = {
        ...
        "mall": {"name": "Mall", "scene": "mall.jpg", "pos": [56.0, 72.0],
                 "entrance": [56, 86], "doors": ["mallFront"]},
    }
