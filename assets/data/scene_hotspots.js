...
var PP_HOTSPOTS = {
  ...
  airOne: [
    // re-measured for the v5 repaint (2026-09-16): 4 rows, bottom row split
    { a: "A026", box: [70.4, 10.6, 13.6, 19.2] },
    { a: "A027", box: [84.7, 10.6, 14.0, 19.2] },
    { a: "A028", box: [70.4, 30.8, 13.6, 18.5] },
    { a: "A029", box: [84.7, 30.8, 14.0, 18.5] },
    { a: "A031", box: [70.4, 50.3, 13.6, 16.8] },
    { a: "A032", box: [84.7, 50.3, 14.0, 16.8] },
    { a: "A121", box: [70.4, 68.2, 13.6, 13.7] },
    { a: "A030", box: [84.7, 68.2, 14.0, 13.7] },
  ...
  regretBurger: [
    ...
    { a: "A040", box: [67.9, 64.6, 14.8, 16.7] },
    { a: "A039", box: [83.3, 64.6, 15.4, 16.7] },
    { a: "A041", work: true, box: [70.5, 84.5, 25.3, 13.5] }
  ],
  gym: [
    ...
    { a: "A048", box: [74.3, 69.1, 23.4, 10.1] },
    { a: "A049", work: true, box: [77.7, 85.3, 20.7, 12.7] }
  ],
  temple: [
    { a: "A058", box: [72.0, 11.0, 9.4, 26.0] },
    { a: "A059", box: [81.9, 11.0, 8.5, 26.0] },
    { a: "A060", box: [90.8, 11.0, 7.7, 26.0] },
    { a: "A061", box: [72.1, 39.0,  9.4, 21.0] },
    { a: "A062", box: [81.9, 39.0,  8.5, 21.0] },
    { a: "A063", box: [90.8, 39.0,  7.7, 21.0] },
    { a: "A064", box: [72.1, 62.2, 12.5, 21.5] },
    { a: "A065", box: [85.4, 62.2, 13.0, 21.5] },
    { a: "A066", work: true, box: [76.0, 84.5, 19.5, 13.5] }
  ],
  university: [
    { a: "A120", box: [74.3, 11.9, 12.4, 23.2] },
    { a: "A068", box: [87.3, 11.9, 10.9, 23.2] },
    { a: "A069", box: [74.3, 37.0, 12.4, 23.4] },
    { a: "A120", box: [87.3, 37.0, 10.9, 23.4] },
    { a: "A120", box: [74.3, 62.2, 12.4, 21.2] },
    { a: "A120", box: [87.3, 62.2, 10.9, 21.2] },
    { a: "A075", work: true, box: [82.8, 87.8, 15.9, 9.0] }
  ],
  soulExchange: [
    { a: "A076", box: [73.6,  9.7, 12.9, 17.2] },
    { a: "A078", box: [86.8,  9.7, 12.5, 17.2] },
    { a: "A079", box: [73.6, 27.3, 12.9, 17.8] },
    { a: "A080", box: [86.8, 27.3, 12.5, 17.8] },
  ...
  debtstreet: [
    ...
    { a: "A119", box: [68.5, 63.0, 29.5, 11.0] },   // v5 repaint: Cash Out replaced Buy Penny Stocks (now in More)
    { a: "A092", work: true, box: [68.5, 83.0, 29.5, 13.5] }
  ],
  airport: [
